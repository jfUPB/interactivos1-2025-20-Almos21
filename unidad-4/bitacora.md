...
[Enlace a la aplicación a modificar](https://editor.p5js.org/generative-design/full/HyrZcq9p1N)
...
[Enlace a la aplicación modificada](https://editor.p5js.org/Almos21/full/_-DggA7Lm)
...
function setup() {
  ...
  // ------ mesh coloring ------
  topColor = color(0, 71, 83);
  midColor = color(272, 100, 36);
  bottomColor = color(0, 0, 0);
  strokeColor = color(263, 67, 100);
  threshold = 0.30;
...
function draw() {
  ...
  // ------ mesh noise ------
  if (microBitAState) {
    noiseXRange = microBitX / 10;
    noiseYRange = microBitY / 10;
  }
...
[Video demostratativo](https://youtu.be/SwIsdtXtngE?si=W2hs6M0r2LclGvEh)
